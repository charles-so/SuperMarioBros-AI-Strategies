...
for episode in range(num_episodes):
    try:  # Start of the try block
        ...
        for step in range(1000):
            ...
            list_training_rewards.append((step, reward))
            done = terminated or truncated

            if done:
                print("end")
                #save_q_table()
                # Save Q-table and rewards data
                #save_data(episode_numbers, average_rewards, episode_q_values, episode_rewards, 'average_data.pkl')
        ...
        average_rewards.append(total_training_rewards/1000)
        episode_rewards.append(list_training_rewards)
...
# Save the final Q-table and rewards data
#save_data(episode_q_values, episode_rewards, 'final_data.pkl')
